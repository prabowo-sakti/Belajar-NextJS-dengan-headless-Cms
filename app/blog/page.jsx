      ...
      <div className="flex flex-wrap">
        ...
        <div className="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
          ...
          <p className="text-gray-800">
            ...
            quia, libero deserunt placeat molestias esse ullam laudantium ipsum
            consequuntur cupiditate cum ea deleniti iusto optio nulla quam sunt
            qui. Fugiat, numquam dolorem?
          </p>
        </div>
      </div>
    </>
